...
public class BabyCreeper extends TameableEntity {
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.createKey(BabyCreeper.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.createKey(BabyCreeper.class, DataSerializers.VARINT);
    ...
    public BabyCreeper(EntityType<? extends BabyCreeper> type, World worldIn) {
        super(type, worldIn);
        this.setTamed(false);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new BabyCreeper.AvoidEntityGoal(this, LlamaEntity.class, 24.0F, 1.5D, 1.5D));
    ...
    public boolean shouldAttackEntity(LivingEntity target, LivingEntity owner) {
        if (!(target instanceof CreeperEntity) && !(target instanceof GhastEntity)) {
            if (target instanceof BabyCreeper) {
                BabyCreeper wolfentity = (BabyCreeper)target;
    ...
    class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
        private final BabyCreeper wolf;

        public AvoidEntityGoal(BabyCreeper wolfIn, Class<T> entityClassToAvoidIn, float avoidDistanceIn, double farSpeedIn, double nearSpeedIn) {
        ...
        private boolean avoidLlama(LlamaEntity llamaIn) {
            return llamaIn.getStrength() >= BabyCreeper.this.rand.nextInt(5);
        }
        ...
        public void startExecuting() {
            BabyCreeper.this.setAttackTarget((LivingEntity)null);
